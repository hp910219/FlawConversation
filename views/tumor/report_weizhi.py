...
def write_version_weizhi():
    para = write_versions([
        {'text': '“HLA Ⅰ类三个基因均杂合，免疫检查点抗体治疗反应更好”改为“HLA Ⅰ类三个基因均纯合，免疫检查点抗体治疗反应更好”', 'time': '2020年9月8日'},
